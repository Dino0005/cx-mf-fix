...
**Nota**: Il file `mf-dlls.zip` non è incluso nella cartella Resources del progetto. Tuttavia, è disponibile all'interno del pacchetto di rilascio precompilato nella sezione [Assets](../../releases/latest) per comodità.
